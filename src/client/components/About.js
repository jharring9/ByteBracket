...
export const About = () => {
  ...
  return (
    <>
      <Helmet title="About - ByteBracket" />
      <LoadingWrapper>
          ...
          <div className="relative px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-lg">
              ...
              <p className="mt-8 text-justify text-lg leading-8 text-gray-500">
                ...
                approaches to prediction. With that, ByteBracket was born with
                the aim of providing everyone with a custom data-driven sports
              ...
              <p className="mt-8 text-justify text-lg leading-8 text-gray-500">
                ...
                first-ever perfect March Madness bracket is finally within
                reach. Our algorithm empowers you to put your understanding of
                the game to the test, arming you with the firepower to achieve
                the impossible.
              </p>
            </div>
            <div className="prose prose-lg prose-indigo mx-auto mt-8 max-w-3xl text-gray-500">
              ...
              <div className="divide-y-4">
                <div>
                  ...
                  <p className="text-justify">
                    ...
                    weights are relative to the weight of the other statistics,
                    so giving every statistic a 10 is equivalent to giving each
                    statistic a 1. The pie chart reflects the percentage
                    strength that each statistic has in the algorithm.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-bold">
                ...
                <div>
                  <h3 className="text-xl font-bold">
                    Step 3: Ranking the Field
                  </h3>
                  <p className="text-justify">
                    The rankings are done by simply sorting each team by their
                    cumulative score. Comparing each team head to head is
                    slightly more involved, and uses a custom formula that we
                    created based on the differences between the two teams in
                    cumulative score.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-justify">
                    ...
                    simulated based on the displayed winning percentages that
                    each team has, which are generated based on your bracket.
                    The simulation accounts for upsets by including randomness
                    in the calculation.
                  </p>
                </div>
              </div>
              ...
              <p className="text-justify">
                The four of us studied computer science at Vanderbilt. We all
                are sports analytics fanatics and hope to improve everyone’s
                bracket creation process.
              </p>
            </div>
            <div className="mx-auto mt-8 max-w-3xl">
              <ul
                role="list"
                className="mx-auto mt-4 grid w-fit grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:mx-0 lg:gap-x-8 xl:col-span-2"
              >
                {people.map((person) => (
                  <li key={person.name}>
                    <a
