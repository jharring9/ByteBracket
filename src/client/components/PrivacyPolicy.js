  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center">
      <div className="mt-4 max-w-7xl">
        ...
        <h2 className="mt-4 text-lg font-bold">Interpretation</h2>
        <p>
        ...
        <h2 className="mt-4 text-lg font-bold">Definitions</h2>
        ...
        <ul className="ml-4 list-disc">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ByteBracket, Nashville, TN.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to ByteBracket, accessible from{" "}
              <a
                href="https://bytebracket.io"
        ...
        <h3 className="mt-2 font-bold">Personal Data</h3>
        <p>
          While using Our Service, We may ask You to provide Us with certain
          personally identifiable information that can be used to contact or
          identify You. Personally identifiable information may include, but is
          not limited to: email address, first and last name, and usage data.
        </p>
        <h3 className="mt-2 font-bold">Usage Data</h3>
        ...
        <h3 className="mt-2 font-bold">Tracking Technologies and Cookies</h3>
        <p>
        ...
        <h3 className="mt-2 font-bold">Business Transactions</h3>
        <p>
        ...
        <h3 className="mt-2 font-bold">Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="mt-2 font-bold">Other legal requirements</h3>
        <p>
